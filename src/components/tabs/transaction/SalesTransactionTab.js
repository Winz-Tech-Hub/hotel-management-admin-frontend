...
function SalesTransactionTab(props) {
  ...
  const urlRef = useRef(ALL_SALES_TRANSACTION)
  ...
  async function deleteTransaction(transactionId) {
    const fetchData = {
      url: SALES_TRANSACTION + transactionId,
      method: 'DELETE',
    }
    let data = null
    try {
...
export default SalesTransactionTab
